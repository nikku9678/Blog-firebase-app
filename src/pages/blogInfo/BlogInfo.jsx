...
import { Timestamp, addDoc, collection, doc, getDoc, onSnapshot, orderBy, query, deleteDoc } from 'firebase/firestore';
...
function BlogInfo() {
  ...
  const deleteComment = async (commentId) => {
    try {
      await deleteDoc(doc(fireDb, "blogPost/" + `${params.id}/` + "comment", commentId));
